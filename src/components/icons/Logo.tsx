...
const Logo = () => {
  return (
    <svg
      className=" lg:w-36 w-28 text-green-500"
      version="1.1"
      id="Слой_1"
    ...
    >
      ...
      <g
        id="Group_5_00000070828790171695622380000000173269121225355165_"
        transform="translate(3855.512 -70.154)"
      >
        <g
          id="Group_4_00000040573702066691528980000015006839419097893768_"
          transform="translate(-2485.834 239.48)"
        >
          <g
            id="Group_3_00000057838741029692913500000002972985526677800881_"
            transform="translate(180.876 88.849)"
          >
            <motion.path
              id="Path_10_00000023268462808725575260000000646245658608255663_"
              variants={svgVariants}
              initial="start"
              animate="finished"
              className="st4"
              d="M-1128.6-104.7v7h-2v-19h8.7
            ...
            />
            <motion.path
              id="Path_11_00000125595755136657040690000018386099957182086072_"
              variants={svgVariants}
              initial="start"
              animate="finished"
              className="st4"
              d="M-1114.7-104.9c0-2.7,0.5-4.5,1.4-5.5
            ...
            />
            <motion.path
              id="Path_12_00000147929877649162060610000016070074546061915290_"
              variants={svgVariants}
              initial="start"
              animate="finished"
              className="st4"
              d="M-1081.2-111.7h2.1
            ...
            />
            <motion.path
              id="Path_13_00000022530410123273192630000011977800466434886321_"
              className="st4"
              variants={svgVariants}
              initial="start"
              animate="finished"
              d="M-1071.1-112c2,0,3.4,0.5,4.2,1.6
            ...
            />
            <motion.path
              id="Path_14_00000082339422046904953840000013801568336924460728_"
              className="st4"
              variants={svgVariants}
              initial="start"
              animate="finished"
              d="M-1057-112.1c0.5,0,0.9,0,1.3,0.1v1.8
            ...
            <motion.path
              ...
              initial="start"
              animate="finished"
              id="Path_15_00000052811959219277355880000017252368898746772883_"
              className="st4"
              d="M-1047.3-112c2,0,3.4,0.5,4.2,1.6
            c0.9,1,1.3,2.9,1.3,5.7h-9.7c0,2.1,0.4,3.5,1,4.3c1,0.8,2.2,1.2,3.5,1.1c1.3,0,2.6-0.3,3.9-0.7l0.4,1.6c-1.4,0.5-2.9,0.7-4.4,0.8
            ...
            <motion.path
              ...
              initial="start"
              animate="finished"
              id="Path_16_00000177481150999057264110000003350779750855729070_"
              className="st4"
              d="M-1032.6-112c1.3-0.1,2.6,0.3,3.9,1.1
            ...
            <motion.path
              ...
              initial="start"
              animate="finished"
              id="Path_17_00000120549364314932920150000000233955694467939727_"
              className="st4"
              d="M-1009.9-112c2.2,0,3.7,0.5,4.7,1.6
            ...
            <motion.path
              ...
              initial="start"
              animate="finished"
              id="Path_18_00000057837115031622291750000017010165633610872731_"
              className="st4"
              d="M-996.5-97.2c-1.3-5-3-9.8-5.1-14.5h2
            ...
            <motion.path
              ...
              initial="start"
              animate="finished"
              id="Path_19_00000014598056604131422680000010955154226553898380_"
              className="st4"
              d="M-977.6-97.7v-19h2v19H-977.6z"
            />
            <motion.path
              variants={svgVariants}
              initial="start"
              animate="finished"
              id="Path_20_00000050647748316048111060000006038867382699133826_"
              className="st4"
              d="M-958.4-114.7h-6.3v17h-2v-17h-7v-2h15.2
            L-958.4-114.7z"
            />
            <motion.path
              variants={svgVariants}
              initial="start"
              animate="finished"
              id="Path_21_00000043418366866358545560000009354566797722588585_"
              className="st4"
              d="M-945.6-104.7v7h-2v-19h8.7
            ...
            <motion.path
              ...
              initial="start"
              animate="finished"
              id="Path_22_00000152953491209038433660000001380157275897412776_"
              className="st4"
              d="M-920.6-106.7v8
            ...
            <motion.path
              ...
              initial="start"
              animate="finished"
              id="Path_23_00000098900259088616665860000000939991441596122511_"
              className="st4"
              d="M-911-112.1c0.5,0,0.9,0,1.3,0.1v1.8
            c-0.5-0.1-0.9-0.1-1.3-0.1c-0.9,0-1.8,0.1-2.6,0.5c-0.6,0.2-1,0.7-1.1,1.3v10.8h-2v-14h2v1c0.4-0.4,0.9-0.8,1.4-1
            ...
            <motion.path
              ...
              initial="start"
              animate="finished"
              id="Path_24_00000134229477827926477510000013686037561940701824_"
              className="st4"
              d="M-896.9-98.7h-1.9c0,0-5.9-6.2-6.8-6.6
